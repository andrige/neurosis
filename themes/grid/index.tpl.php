...
<div id='outer-wrap-site'>
  <?php if(region_has_content('admin-menu')): ?>
  <div id='outer-wrap-admin-menu'>
    <div id='inner-wrap-admin-menu'>
      <div id='admin-menu'><?=render_views('admin-menu')?></div>
    </div>
  </div>
  <?php endif; ?>
...
<div id='outer-wrap-main'>
  <div id='inner-wrap-main'>
    <?php if(region_has_content('primary', 'sidebar')): ?>
      <div id='primary'><?=get_messages_from_session()?><?=render_views('primary')?></div>  <!-- shared_functions::render_views(), and argument should be for $ne->views[$argument]  -->
      <div id='sidebar'><?=render_views('sidebar')?></div>
    <?php endif; ?>
    <?php if(region_has_content('fullwidth')): ?>
      <div id='fullwidth'><?=get_messages_from_session()?><?=render_views('fullwidth')?></div>
    <?php endif; ?>
  </div>
</div>
<?php endif; ?>
