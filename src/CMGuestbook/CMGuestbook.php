 ...
 * See: http://dbwebb.se/forum/viewtopic.php?p=1099#p1099
 *
...
/*
To make it easier for us, we use 'extends CObject' so we can gain access
-to internal variables through '$this'. This is not required but it's
-easier for us.
*/
