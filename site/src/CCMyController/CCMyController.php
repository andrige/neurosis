 ...
 *==========================================================================
 * 
 * As this file CCMyController is inside the /site/ subfolder, it's intended 
 * use is for the end-user who wants to use the framework. They'll interact 
 * primarily with the /site/ folder. 
 * 
 */
