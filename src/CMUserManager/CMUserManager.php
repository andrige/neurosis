...
/**=========================================================================
 * 
 * Get admin related information from database
 *
 *==========================================================================
 * 
...
class NULL extends CObject implements IHasSQL, IModule {
  ...
  public function GetUser($userId) {
    try {
      // echo $userId;
      // echo $this->db->ExecuteSelectQueryAndFetchAll(self::SQL('select * from user where id'),array($userId));
